...
module.exports = {
  ...
  async execute(message){
    ...
    if(message.content.includes("map") && (!message.content.includes("value") && (!message.content.includes("iterate")))) {
      ...
      return;
    } else if (message.content.includes('type') || message.content.includes('types') || message.content.includes('Types')){
    ...
    // feedback collection
      ...
      return;
    } else if((message.content.includes("how") || message.content.includes("How")) && message.content.includes("update")){
      ...
      return;
    } else if (message.content.includes('balance') && (message.content.includes('zero') || (message.content.includes('exit')) )) {
      ...
      return;
    } else if(message.content.includes('insufficient') && message.content.includes('balance') && message.content.includes('transfer')){
      ...
      return;
    } else if(message.content.includes('expected') && message.content.includes('args') && message.content.includes('got')){
      ...
      return;
    } else if(message.content.includes('invalid') && message.content.includes("unbound") && message.content.includes('identifier')){
      ...
      return;
    } else if((message.content.includes('What') || message.content.includes("what")) && message.content.includes("gas") && message.content.includes('fees')){
      ...
      return;
    } else if((message.content.includes('Participant Interact Interface') || message.content.includes('participant interact interface')) && (message.content.includes('what') || message.content.includes('What'))){
      ...
      return;
    } else if ((message.content.includes("local") || message.content.includes('Local')) && (message.content.includes('What') || message.content.includess('what')) && (message.content.includes('step') || message.content.includes('Step'))){
      ...
      return;
    } else if ((message.content.includes('Consensus Step') || message.content.includes('consensus step')) && (message.content.includes('What') || message.content.includes('what'))){
      ...
      return;
    } else if ((message.content.includes('what') || message.content.includes('What')) && (message.content.includes('step') || message.content.includes('Step'))) {
      ...
      return;
    } else if(message.content.includes('launch') && message.content.includes('token')){
      ...
      return;
    } else if((message.content.includes('Testnet') || message.content.includes('testnet')) && (message.content.includes('What') || message.content.includes('what'))){
